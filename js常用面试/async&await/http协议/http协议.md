...
<center>  
![tcp协议](https://images0.cnblogs.com/blog/622045/201507/020946553127518.png)
</center>

1. 在浏览器中输入url

     用户输入url，例如http://www.baidu.com。
     其中http为协议，www.baidu.com为网络地址，及指出需要的资源在那台计算机上。一般网络地址可以为域名或IP地址，此处为域名。使用域名是为了方便记忆，但是为了让计算机理解这个地址还需要把它解析为IP地址。
2. 应用层DNS解析域名
...
<center>  
![三次握手](https://images0.cnblogs.com/blog/622045/201507/020946560314133.png)
</center>
5. 网络层IP协议查询MAC地址(接受方地址)
